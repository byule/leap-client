 ...
 * @public
 */
export declare class ProcessorController extends EventEmitter<{
    ...
    statuses(type?: string): Promise<(ZoneStatus | AreaStatus | TimeclockStatus)[]>;
    /**
...
//# sourceMappingURL=ProcessorController.d.ts.map